              ...
              ElevatedButton(
                onPressed: () async {
                  if (subjectController.text != "" &&
                    ...
                    String MeetingKey = fetchScheduledMeetingKey(
                    ...
                    var whatsappAndroid = Uri.parse(
                        "whatsapp://send?phone=$whatsapp&text=<B>TringTring Video Calling</b><br>Use Meeting Key: $MeetingKey (or) Use Meeting URL: https://meet.jit.si/$MeetingKey");
